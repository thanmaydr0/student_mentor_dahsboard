    ...
    <AppShell role={role as 'student' | 'mentor'}>
      ...
      >
        ...
        <motion.div variants={itemVariants} className="flex flex-col gap-1">
          <h1 className="text-2xl font-bold text-brand-900 dark:text-white sm:text-3xl">Profile</h1>
          <p className="text-sm font-medium text-brand-500 dark:text-slate-400">Manage your personal information</p>
        </motion.div>
          ...
          <Card>
            ...
            <div className="flex flex-col items-center gap-4 pb-6 sm:flex-row sm:items-start">
              ...
              <div className="flex flex-1 flex-col items-center gap-1 sm:items-start">
                <h2 className="text-xl font-bold text-brand-900 dark:text-white">{profile?.full_name || 'User'}</h2>
