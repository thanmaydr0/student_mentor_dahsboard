    ...
    <AppShell role="mentor">
      <div className="flex flex-col gap-6 max-w-7xl mx-auto w-full pb-10 h-full">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div>
            <h1 className="text-2xl font-bold tracking-tight text-brand-900 dark:text-white sm:text-3xl flex items-center gap-2">
              <Calendar className="text-brand-600" /> Teaching Schedule
            </h1>
            <p className="mt-1 text-sm font-medium text-brand-500 dark:text-slate-400">
              Manage your assigned classes and log attendance across all branches.
            </p>
          </div>

          <div className="flex items-center gap-2 bg-white dark:bg-[#13151a]/50 p-1 rounded-xl shadow-sm border border-slate-200 dark:border-white/10 w-fit">
            <button
        ...
        {/* Timetable Grid */}
        <div className="bg-white dark:bg-[#13151a]/50 rounded-2xl shadow-sm border border-slate-200 dark:border-white/10 overflow-hidden flex-1 flex flex-col min-h-[600px]">
