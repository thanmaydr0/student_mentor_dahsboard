          ...
          <div>
            <div className="flex items-center gap-4 mb-4">
              ...
              <div className="flex gap-2 w-full sm:w-auto">
                {parentId && (
                  <button 
                    onClick={() => setShowParentChat(true)}
                    className="flex-1 sm:flex-none flex items-center justify-center gap-2 rounded-xl bg-amber-500/10 px-4 py-2.5 text-sm font-bold text-amber-600 transition-colors hover:bg-amber-500/20"
                  >
                ...
                <button 
                  ...
                  className="flex-1 sm:flex-none flex items-center justify-center gap-2 rounded-xl bg-brand-50 px-4 py-2.5 text-sm font-bold text-brand-700 transition-colors hover:bg-brand-100 dark:bg-brand-900/30 dark:text-brand-300 dark:hover:bg-brand-900/50"
                >
                  <MessageSquare size={16} />
                  Message
                </button>
