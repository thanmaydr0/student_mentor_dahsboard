      ...
      <div className="flex flex-col gap-6 max-w-6xl mx-auto w-full pb-10">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div>
            ...
            <p className="text-sm text-slate-500 dark:text-slate-400 mt-1">Automatically sync and view attendance for Theory and Lab from the college ERP.</p>
          </div>
        ...
        <div className="bg-white dark:bg-[#13151a]/50 rounded-2xl shadow-sm border border-slate-200 dark:border-white/10 p-5">
          <div className="flex flex-col sm:flex-row gap-4 items-end">
             <div className="w-full sm:w-1/2">
                <label className="block text-sm font-semibold text-slate-700 dark:text-slate-200 mb-1.5">Select Class</label>
                {isLoadingClasses ? (
                  ...
                  <select 
                    ...
                    className="w-full rounded-xl border-slate-200 dark:border-white/10 bg-slate-50 dark:bg-white/5 py-2.5 text-sm focus:ring-brand-500 focus:border-brand-500 disabled:opacity-60 dark:text-slate-200"
                  >
             ...
             <div className="w-full sm:w-auto">
               {activeQuery ? (
                 <button 
                   ...
                   className="w-full py-2.5 px-6 rounded-xl font-semibold border-2 border-slate-200 dark:border-white/10 text-slate-600 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-white/5 transition"
                 >
                   Change Selection
                 </button>
               ) : (
