      ...
      <div className="mx-auto flex w-full max-w-7xl flex-col gap-8 pb-10">
        ...
        >
          ...
          <div className="flex flex-col gap-4 border-b border-slate-200 pb-5 sm:flex-row sm:items-start sm:justify-between">
            <div>
              ...
              <h1 className="text-2xl font-black text-slate-900 dark:text-white sm:text-3xl">VTU Results Dashboard</h1>
        ...
        <div className="grid gap-6 lg:grid-cols-3">
          ...
          <div className="lg:col-span-1 space-y-6">
            {/* USN + Fetch */}
            <div className="rounded-2xl border border-slate-200 dark:border-white/10 bg-white dark:bg-[#13151a]/50 shadow-sm overflow-hidden">
              <div className="flex items-center justify-between border-b border-slate-100 dark:border-white/5 px-5 py-3.5">
                <h3 className="text-sm font-bold text-slate-900 dark:text-white">Fetch Results</h3>
            ...
            <div className="rounded-2xl border border-slate-200 dark:border-white/10 bg-white dark:bg-[#13151a]/50 shadow-sm overflow-hidden">
              <div className="flex items-center justify-between border-b border-slate-100 dark:border-white/5 px-5 py-3.5">
                <h3 className="text-sm font-bold text-slate-900 dark:text-white">Student Queue</h3>
